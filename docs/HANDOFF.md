...
- On Now Playing, wheel rotation changes system media volume and temporarily replaces the track
  progress/timing area with an iPod-style volume meter; it does not open Android's volume panel.
